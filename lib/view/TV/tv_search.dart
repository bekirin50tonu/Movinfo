...
class TVSearchView extends StatefulWidget {
  const TVSearchView({Key? key, Object? data}) : super(key: key);
...
class _TVSearchViewState extends BaseState<TVSearchView> {
  ...
  int pageCount = 1;
  List<TVModel> _items = [];
  StreamController<List<TVModel>> _streamBuilder = StreamController();
  String suggestion = "";
  int itemCount = 0;
  int tempCount = 0;
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          print("DataIndex: " +
                              ...
                              "\nItemCount" +
                              itemCount.toString());
                          TVModel data = snapshot.data[dataIndex];
  ...
  buildTvViewer(TVModel data, int index) {
    ...
    final releaseDate = data.results![index].firstAirDate != "" ||
            DateTime.parse(data.results![index].firstAirDate!).isUtc
